...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ~/.claude
                  → checks /Users/clarence/kova-app/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/clarence/kova-app/.claude/get-shit-done
                  → writes to /Users/clarence/kova-app/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/clarence/kova-app/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/clarence/kova-app/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/clarence/kova-app/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
