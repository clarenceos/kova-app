...
<required_reading>
@/Users/clarence/kova-app/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/clarence/kova-app/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
