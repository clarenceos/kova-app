...
Plans:
- [x] 08-01-PLAN.md — Install shadcn form components, create organizer layout, build createCompetition server action
- [x] 08-02-PLAN.md — Competition creation form with live serial prefix preview, competition list page with copyable registration links
...
- [x] 09-02-PLAN.md — Registration form page with guard states, personal details, country combobox, event selection with inline bell weight/duration config
- [x] 09-03-PLAN.md — Registration success page showing assigned serial numbers with "Register another athlete" button
...
- [x] 10-02-PLAN.md — Registrations table with sort, filter, event pills, and remove registrant dialog
- [x] 10-03-PLAN.md — CSV import modal, QR code modal, and Generate Queue modal
